                                        ...
                                        <ul class="md-list md-list-addon">
                                            <li>
                                                <div class="md-list-addon-element">
                                                    <span class="md-user-letters md-bg-cyan">jr</span>
                                                </div>
                                                <div class="md-list-content">
                                                    <span class="md-list-heading"><a href="page_mailbox.html">Eum nesciunt.</a></span>
                                                    <span class="uk-text-small uk-text-muted">Laudantium commodi minus reiciendis dolorum vel distinctio itaque itaque.</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="md-list-addon-element">
                                                ...
                                                <div class="md-list-content">
                                                    <span class="md-list-heading"><a href="page_mailbox.html">Provident consequatur.</a></span>
                                                    <span class="uk-text-small uk-text-muted">Enim ut temporibus iure adipisci neque.</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="md-list-addon-element">
                                                    <span class="md-user-letters md-bg-light-green">wc</span>
                                                </div>
                                                <div class="md-list-content">
                                                    <span class="md-list-heading"><a href="page_mailbox.html">Rem corporis.</a></span>
                                                    <span class="uk-text-small uk-text-muted">Sint laudantium atque error numquam maxime et.</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="md-list-addon-element">
                                                ...
                                                <div class="md-list-content">
                                                    <span class="md-list-heading"><a
                                                                href="page_mailbox.html">Odio eum.</a></span>
                                                    <span class="uk-text-small uk-text-muted">Saepe beatae voluptates ad deserunt ea aperiam eligendi.</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="md-list-addon-element">
                                                ...
                                                <div class="md-list-content">
                                                    <span class="md-list-heading"><a href="page_mailbox.html">Consequuntur quaerat et.</a></span>
                                                    <span class="uk-text-small uk-text-muted">Et cum impedit dolores aut atque velit modi est odit et.</span>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <li>
                                        <ul class="md-list md-list-addon">
                                            <li>
                                                ...
                                                <div class="md-list-content">
                                                    <span class="md-list-heading">Qui veniam doloremque.</span>
                                                    <span class="uk-text-small uk-text-muted uk-text-truncate">Voluptatem ut ipsum consequuntur.</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="md-list-addon-element">
                                                ...
                                                <div class="md-list-content">
                                                    <span class="md-list-heading">Beatae possimus dolorem.</span>
                                                    <span class="uk-text-small uk-text-muted uk-text-truncate">Et placeat exercitationem recusandae impedit nobis distinctio ipsa.</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="md-list-addon-element">
                                                ...
                                                <div class="md-list-content">
                                                    <span class="md-list-heading">Nihil ducimus.</span>
                                                    <span class="uk-text-small uk-text-muted uk-text-truncate">Et sunt soluta suscipit ex recusandae molestiae.</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="md-list-addon-element">
                                                ...
                                                <div class="md-list-content">
                                                    <span class="md-list-heading">Similique vel ducimus.</span>
                                                    <span class="uk-text-small uk-text-muted uk-text-truncate">Repellendus perferendis necessitatibus eos architecto omnis.</span>
                                                </div>
                                            </li>
                                        </ul>
                                    </li>
        ...
        <ul>
            ...
            <li title="Components">
                ...
                <ul>
                    ...
                    <li><a href="components_smooth_scroll.html">Smooth Scroll</a></li>
                    <li><a href="components_sortable.html">Sortable</a></li>
            ...
            <li title="Pages">
                ...
                <ul>
                    ...
                    <li><a href="page_contact_list_horizontal.html">Contact List Horizontal</a></li>
            ...
            <div class="md-card-content">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-1-1">
                        Culpa officiis sit temporibus est voluptatem officiis delectus exercitationem omnis sunt est ut
                        reprehenderit molestiae cumque nesciunt nobis natus facilis iste ut dignissimos perferendis quis
                        consequatur et sequi ea maxime a esse quis quisquam ea quia architecto sunt cupiditate occaecati
                        aspernatur qui repudiandae ab sit rerum repellendus hic quasi veniam molestiae ex maxime beatae
                        eius consequuntur sunt vel nulla repellendus praesentium omnis molestiae fugiat quia atque magni
                        debitis ipsam nam doloribus et corrupti est dolore quia iste dolores natus nemo autem
                        dignissimos nihil nulla mollitia vitae vero quis labore non adipisci dolor voluptatum voluptatem
                        laboriosam eos nulla a voluptas nulla fugit voluptas vero sed in earum enim corporis architecto
                        nulla quasi praesentium non dolore at repudiandae ducimus quia voluptas tempore adipisci aut
                        facere harum at voluptate ea delectus commodi minus in laboriosam doloremque reprehenderit
                        saepe.
                    </div>
                </div>
            </div>
