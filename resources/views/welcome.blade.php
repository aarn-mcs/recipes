        ...
        <div class="md-card-content large-padding" id="login_form">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="uk-form-row">
                    ...
                    <input class="md-input" type="text" id="login_username" name="email" value="{{ old('email') }}" required autofocus/>
                    @if ($errors->has('email'))
                ...
                <div class="uk-margin-top">
                    ...
                    <span class="icheck-inline">
                            <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }} id="login_page_stay_signed"
                                   data-md-icheck/>
